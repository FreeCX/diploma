...
\begin{frame}
    ...
    \begin{figure}[h]
        \center
        \includegraphics[width=0.8\linewidth]{img_01}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \center
        \includegraphics[width=0.8\linewidth]{1-01}
        % \includegraphics[width=1.0\linewidth]{1-01}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \center
        \includegraphics[width=0.6\linewidth]{band_profile}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \begin{minipage}[h]{0.49\linewidth}
            \center{\includegraphics[width=1.0\linewidth]{3d_B}}
        \end{minipage}
        \hfill
        \begin{minipage}[h]{0.49\linewidth}
            \center{\includegraphics[width=1.0\linewidth]{map_B}}
        \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \begin{minipage}[h]{0.49\linewidth}
            \center{\includegraphics[width=1.0\linewidth]{3d_F1}}
        \end{minipage}
        \hfill
        \begin{minipage}[h]{0.49\linewidth}
            \center{\includegraphics[width=1.0\linewidth]{map_F1}}
        \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \begin{minipage}[h]{0.49\linewidth}
            \center{\includegraphics[width=1.0\linewidth]{3d_F2}}
        \end{minipage}
        \hfill
        \begin{minipage}[h]{0.49\linewidth}
            \center{\includegraphics[width=1.0\linewidth]{map_F2}}
        \end{minipage}
    \end{figure}
\end{frame}