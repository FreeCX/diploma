...
\begin{thebibliography}{10}
    ...
    \bibitem{bib:48} Шербина О. А. Метаэвристические алгоритмы для задач комбинаторной оптимизации %% http://tvim.info/files/56_72_Shcherbina.pdf
    \bibitem{bib:49} Ивницкий Д. Н., Кочетов Ю. А. Вероятностный поиск с запретами для задачи 
