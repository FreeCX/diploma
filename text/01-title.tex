\begin{titlepage}
    ...
    \begin{center}
        ...
        \UNDER{к \underline{\hspace{0.2\textwidth}магистерской дисертации\hspace{7em}} на тему}
...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        <<\underline{\hspace{2em}}>> \underline{\hspace{8em}} \the\yearг.
    \end{flushright}
    Задание на \UNDER{\underline{\hspace{0.2\textwidth}магистерскую дисертацию\hspace{10.5em}}}
        {\TINY{(наименование вида работ)}}\\
