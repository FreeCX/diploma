\begin{titlepage}
    ...
    Обозначение \UNDER{\underline{\smash{\hspace{6em}МД-40461806-10.27-01-16.81\hspace{10.5em}}}}
    ...
    \vspace{5pt}\UNDER{\underline{программа \ldots\hspace{0.5\textwidth}}}{(код по ОКСО, наименование направления, программы)}\\
...
\begin{titlepage}
    ...
    Тема \vspace{0.5em}\underline{\smash{Методы построения маршрутов общественного транспотра на основе\hspace{1em}}}\\
