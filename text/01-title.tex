\begin{titlepage}
    ...
    \UNDER{\underline{\smash{\hspace{2.9em}\STUDENTO\hspace{3.1em}}}}{\TINY{(фамилия, имя, отчество)}}\\
    Обозначение \UNDER{\underline{\smash{\hspace{6em}\MASTERWORK\hspace{9.2em}}}}
        {\TINY{(обозначение документа)}}\\
    Группа \UNDER{\underline{\hspace{1em}\smash{САПР 2п1}\hspace{1em}}}{\TINY{(шифр группы)}}\\
    Направление \underline{\hspace{0.5em}09.04.01 <<Информатика и вычислительная техника>>,}\\
    \vspace{5pt}\underline{\smash{программа <<Информационное и программное обеспечение 
        автоматизирован-}}\\
    \vspace{5pt}\UNDER{\underline{\smash{ных систем в производстве>>}\hspace{0.63\textwidth}}}
    ...
    Нормоконтролер \UNDER{\LINE{7cm}}{\TINY{(подпись, дата подписания)}}\hquad
        \UNDER{\underline{\smash{\hspace{2em}Н.~П.~Садовникова\hspace{1.8em}}}}{\TINY{(инициалы и фамилия)}}\\
    \vspace{\fill}
    \begin{center}
        Волгоград \the\year\ г.
    \end{center}
...
\begin{titlepage}
    ...
    Задание на \UNDER{\underline{\smash{\hspace{0.2\textwidth}магистерскую диссертацию\hspace{10.5em}}}}
        {\TINY{(наименование вида работ)}}\\
    Студента \UNDER{\underline{\smash{\hspace{2em}\STUDENTT\hspace{13em}}}}{\TINY{(фамилия, имя, отчество)}}\\
    Код кафедры \vspace{1em}\underline{\hspace{2em}10.27\hspace{5em}}\quad\qquad
    Группа \underline{\hspace{3em}САПР-2п1\hspace{5em}}\\
    Тема \vspace{0.5em}\underline{\smash{Метод построения маршрутов общественного транспотра на 
        основе\hspace{1.7em}}}\\
    \vspace{0.5em}\hspace*{12mm}\underline{\smash{предпочтения жителей.\hspace{22em}}}\\
    \vspace{0.5em}\hspace*{12mm}\underline{\hspace{0.93\textwidth}}\\
    \vspace{1em}Утверждена приказом по ВолгГТУ от <<\underline{\smash{06}}>> \underline{\smash{октября}}
        2014 г. \textnumero \underline{\smash{\hspace{1em}1449-ст}\hspace{3em}}\\
    ...
    \end{center}
    1) \underline{\smash{Алгоритмы маршрутизации -- 3...4 листа}\hspace{15.5em}}\\\LINE{\textwidth}\\
    2) \underline{\smash{Рисунки полученных результатов -- 3...5 листов}\hspace{12.4em}}\\\LINE{\textwidth}\\
    3) \underline{\smash{Плакаты -- 2...3 листа}\hspace{24.2em}}\\\LINE{\textwidth}\\
