\begin{titlepage}
    ...
    \begin{center}
        ...
        \UNDER{к \underline{\hspace{0.2\textwidth}магистерской диссертации\hspace{7em}} на тему}
    ...
    \UNDER{\underline{\hspace{2.9em}\STUDENTO\hspace{2.85em}}}{\TINY{(фамилия, имя, отчество)}}\\
    Обозначение \UNDER{\underline{\hspace{6em}МД-40461806-10.27-01-16.81\hspace{9.55em}}}
    ...
    \UNDER{\underline{программа\hspace{0.87\textwidth}}}{(код по ОКСО, наименование направления, программы)}\\
    Руководитель работы \UNDER{\LINE{12.3em}}{\TINY{(подпись и дата подписания)}}\hspace{2em}
        \UNDER{\underline{\hspace{1.5em}М.~В.~Щербаков\hspace{1.5em}}}{\TINY{(инициалы и фамилия)}}\\
    ...
    Нормоконтролер \UNDER{\LINE{7cm}}{\TINY{(подпись, дата подписания)}}\hquad
        \UNDER{\underline{\hspace{2em}Н.~П.~Садовникова\hspace{2em}}}{\TINY{(инициалы и фамилия)}}\\
    \vspace{\fill}
    \begin{center}
        Волгоград \the\year\ г.
    \end{center}
...
\begin{titlepage}
    ...
    \end{flushright}
    Задание на \UNDER{\underline{\hspace{0.2\textwidth}магистерскую диссертацию\hspace{10.5em}}}
        {\TINY{(наименование вида работ)}}\\
    Студента \UNDER{\underline{\hspace{2em}\STUDENTT\hspace{12.8em}}}{\TINY{(фамилия, имя, отчество)}}\\
